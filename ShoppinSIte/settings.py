"""
Django settings for ShoppinSIte project.
...
ROOT_URLCONF = 'ShoppinSIte.urls'

TEMPLATES = [
    {
        'BACKEND': 'django.template.backends.django.DjangoTemplates',
        'DIRS': [os.path.join(BASE_DIR, "ShoppinSIte/Templates")],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
WSGI_APPLICATION = 'ShoppinSIte.wsgi.application'
